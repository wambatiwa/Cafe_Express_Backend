...
router.get('/getByCategory/:id',auth.authentificationToken,(req,res,next)=> {
...
router.get('/getById/:id',auth.authentificationToken,(req,res,next)=> {
    const id = req.params.id;
...
router.patch('/updateStatus', auth.authentificationToken,roleCheck.checkRole,(req,res,next)=> {
    let user  = req.body;
...
router.delete('/delete/:id',auth.authentificationToken,roleCheck.checkRole,(req,res,next)=> {
    const id = req.params.id;
